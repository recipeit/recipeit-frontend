<template>
  <div class="auth-main__content">
    ...
    <AuthSocialList
      @lockInputs="socialSending = true"
      @unlockInputs="socialSending = false"
    />
...
import { emailSchema, passwordSchema } from "@/src/configs/schemas";
import { BASE_URL } from "@/src/configs/url";

import { AUTH_LOGIN } from "@/src/router/paths";

import recaptcha from "@/src/services/recaptcha";

import AuthSocialList from "@/src/views/auth/AuthSocialList";
