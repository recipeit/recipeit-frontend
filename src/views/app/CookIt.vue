    ...
    <div class="cook-it-layout">
      ...
      >
        ...
        <template
          v-if="
            Object.values(
              almostAvailableRecipesList.recipes.value.fetchingPages
            ).some((v) => v) ||
              almostAvailableRecipesList.recipes.value.pagedItems['1']?.length >
                0
          "
          #above-list
        >
          <div class="almost-available-horizontal">
            ...
            <HorizontalRecipesList
              ...
              @reload-with-query="
                almostAvailableRecipesList.reloadRecipesWithQuery($event)
              "
              @showAll="
        ...
        <template #count="{ count, fetching }">
          ...
          >
            ...
            <span>
              ...
              >, {{ count === 1 ? "który" : "które" }} możesz przygotować z
              tego, co juz masz!
            </span>
          </div>
        </template>
        ...
        <template #empty-with-filters>
          <div class="empty-list-message">
            ...
            <p
              v-if="almostAvailableRecipesList.recipes.value.totalCount"
              class="empty-list-message-sub"
            >
              Możesz
              <BaseLink
                tag="button"
                class="empty-list-message-link"
                color="primary"
                @click="reloadRecipes({})"
              >
                wyczyścić filtry
              ...
              <NuxtLink
                ...
                :to="{ name: 'recipes', query: $route.query }"
                custom
              >
                <BaseLink
                  :href="href"
              ...
              <NuxtLink
                v-slot="{ href, navigate }"
                :to="{ name: 'almost-available', query: $route.query }"
                custom
              >
                <BaseLink
                  :href="href"
...
export default {
  ...
  setup() {
    ...
    const almostAvailableRecipesList = recipeFilteredPagedList(
