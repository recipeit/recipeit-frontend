...
const Plugin = {
  install: app => {
    ...
    app.directive('clipboard', {
        ...
        if (arg === 'error') {
          ...
          const clickEventHandler = event => {
            if (value) {
              ...
              const handlerId = $clipboard(payload.value) ? el.dataset.clipboardSuccessHandler : el.dataset.clipboardErrorHandler
      ...
      unmounted(el) {
        const { clipboardSuccessHandler, clipboardErrorHandler, clipboardClickHandler } = el.dataset
